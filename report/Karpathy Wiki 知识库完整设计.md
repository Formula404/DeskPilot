...
> 实现状态（2026-07-10）：核心闭环已经落地，包括网页/文本/Markdown/TXT Ingest、版本快照与去重、Compile Proposal、Review、FTS Query、带引用回答、Lint、数据库备份与索引重建、Agent/API 接入，以及设置页中的状态、策略、目的、提案和维护操作。PDF/DOCX/图片、多知识库 Profile、定时网页更新和向量检索属于 Phase 5 增强能力，不是核心运行依赖。
